...
class OpenAIClient:
    ...
    def call_openai_with_response_format(
        self, messages, model="gpt-4o-mini", response_format=None
    ):
        """
    ...
    def call_openai(self, messages, model="gpt-4o-mini"):
        """
        Calls the OpenAI API with the given messages and model.
        ...
        try:
            completion = self.client.invoke(model=model, input=messages)
            return completion.content
